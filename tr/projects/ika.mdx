---
title: 'İKA'
description: 'T3 Gemstone O1 ve ROS 2 ile modüler bir insansız kara aracı geliştirmek: Bumin İKA örneği ve genel yöntem'
---
...
Bumin İKA'nın asıl mimari fikri, her sensör/eyleyicinin aynı beş adımlık kalıpla eklenmesidir. Bu
kalıbı takip ederek Gemstone üzerinde kendi modüler İKA'nızı oluşturabilirsiniz:
...
etkilemez. Bu da hem Bumin İKA'yı hem de bu yöntemle geliştirilecek herhangi bir İKA'yı, tek bir
Gemstone O1 kartı üzerinde kolayca genişletilebilir, modüler bir geliştirme ortamına dönüştürür.

## 8. Kaynak ve Dokümantasyon
